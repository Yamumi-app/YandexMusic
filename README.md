...
Obtain a token by inspecting network requests from the [Yandex Music web app](https://music.yandex.ru) or official clients. The token is passed via the `Authorization: OAuth <token>` header.
